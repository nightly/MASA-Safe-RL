...
The meaning of a cost is entirely user-defined, but it must stay consistent across episodes and evaluation.
...
This ensures clear and compositional semantics, compatibility with abstractions, automata, and shielding, and independence from hidden environment state.
...
| Stateful costs | Supported via constraints such as DFA-based monitors |
...
- maintain internal state such as DFA states or counters,
...
For full details on the constraint interface, lifecycle, and provided implementations, see the [Constraints API Reference](../../Common/Constraints).
